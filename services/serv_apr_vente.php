...
?>
                ...
                ?>
                             ...
                             <div class="col-md-4">
                                <a href="../point_de_vente/index.php?id=<?php echo $point_de_vente['id_point_vente'] ;?>" class="pt-4 pb-4">
                                    <h5 class="nav-link3 pl-2" style="border-left:5px solid rgb(219,2,23)"><?php echo $point_de_vente['titre_point_vente'] ;?> </h5>
                                 </a>
  ...
  <div class="container">
  <h1 class="mt-4 mb-2 text-light display-4 font-weight-bold">Service client</h1>

  <div class="row mt-4 d-flex justify-content-center">
    <div class="col-md-6 text-light">
    <img src="../images/slider/apre_vente.jpg" alt="" class="img-fluid">

    </div>
</div>
  <div class="row mt-5 text-light mb-5">
        <div class="">
    <p> Notre annuaire télécoms est là pour vous offrir un service de connexion d’appel efficace et rapide aux nombreux organismes gouvernementaux et entreprises populaires de France. Trouvez les numéros officiels dans le domaine public peut être difficile à certains moments – pour épargner aux clients du temps et des efforts inutiles, nous avons réaliser ces recherches pour vous afin de mettre les consommateurs en relation notre plate-forme de télécoms vers leurs destinataires souhaités. La majorité de nos numéros de téléphone vous mettent directement en contact avec les principaux numéros de service client de l’entreprise concernée. D’autres peuvent vous mettre en relation avec une ligne de vente dédiée, et certains entrent en contact avec les deux.

Afin de vous offrir une plus grande valeur ajoutée, nous avons également ajouté les invites de menu. Cela vous permettra de gagner du temps lorsque vous passez votre appel, en contactant directement le service que vous souhaitez sans avoir à écouter le long menu d’appel. Sur chacune des pages des entreprises, vous trouverez également les informations importantes et des conseils pour une expérience totalement transparente.</p>
      </div>
