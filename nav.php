    ...
    <nav class="navbar navbar-expand-lg navbar-dark text-light  bg-secondary" style="color: white !important; ">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <li class="nav-item dropdown" style="position: initial;">
                        <a class="nav-link2 nav-link second_hover" href="tout_produit.php">
                            Produit
                        </a>
                ...
                ?>
                     ...
                     <div class="col-3 mt-4">
                       <div  style="border-left:5px solid rgb(219,2,23)">
                          <a href="famille.php?id=<?php echo $famille['id_famille']; ?>" class=" pt-4 pb-4 nav-link3 ">
...
?>
              ...
              if($bdd->query($sql)){
                ...
                ?>
                       ...
                       <div class="mt-4">
                         <div class="col ">
                            <a href="marque.php?id=<?php echo $marque['id_marque'] ?>" class="pt-4 pb-4 nav-link3 ">
                    ...
                    <li class="nav-item dropdown" style="position: initial;">
                        ...
                        <div class="dropdown-menu w-100" aria-labelledby="navbarDropdown5">
                         <div class="container">
                           <div class="row mt-4">
                             <div class="col-md-4">
                                <a href="installation.php" class="pt-4 pb-4 nav-link3 ">
                                    <h5 class="pl-2" style="border-left:5px solid rgb(219,2,23)">Installation</h5>
                                 </a>
                                
                             </div>
                             <div class="col-md-4">
                                <a href="serv_apr_vente.php" class="pt-4 pb-4 nav-link3 ">
                                    <h5 class="pl-2" style="border-left:5px solid rgb(219,2,23)">Service client</h5>
                                 </a>
                                
                             </div>
                             <div class="col-md-4">
                                <a href="prix_choc.php" class="pt-4 pb-4 nav-link3 ">
              ...
              if($bdd->query($sql)){
                ...
                ?>
                             ...
                             <div class="col-md-4">
                                <a href="point_de_vente.php?id=<?php echo $point_de_vente['id_point_vente'] ;?>" class="pt-4 pb-4 nav-link3 ">
        ...
        <form action="recherche.php" method="post" class="form-inline my-2 my-lg-0">
          <input name="recherche" class="form-control mr-sm-2 focusedInput" type="search" placeholder="Rechercher" aria-label="Search">
          <button class="btn btn-outline-danger my-2 my-sm-0" type="submit"><i class="fas fa-1x fa-search"></i></button>
        </form>
      </div>
