                     ...
                     <div class="col-3 mt-4">
                       <div  style="border-left:5px solid rgb(219,2,23)">
                          <a href="../famille/index.php?id=<?php echo $famille['id_famille']; ?>" class="pt-4 pb-4">
                              <h5 class="pl-2 nav-link3" > <?php echo $famille['titre_famille']; ?></h5>
                       ...
                       <div class="mt-4">
                         <div class="col ">
                            <a href="../marque/index.php?id=<?php echo $marque['id_marque'] ?>" class="pt-4 pb-4">
                                <h5 class="pl-2 nav-link3" style="border-left:5px solid rgb(219,2,23)"><?php echo $marque['titre_marque']; ?></h5>
                             </a>
                           ...
                           <div class="row mt-4">
                             <div class="col-md-4">
                                <a href="../services/installation.php" class="pt-4 pb-4">
                                    <h5 class="pl-2 nav-link3" style="border-left:5px solid rgb(219,2,23)">Installation</h5>
                                 </a>
                                
                             </div>
                             <div class="col-md-4">
                                <a href="../services/serv_apr_vente.php" class="pt-4 pb-4">
                                    <h5 class="pl-2 nav-link3" style="border-left:5px solid rgb(219,2,23)">Service client</h5>
                                 </a>
                                
                             </div>
                             <div class="col-md-4">
                                <a href="../services/prix_choc.php" class="pt-4 pb-4">
                                    <h5 class="pl-2 nav-link3" style="border-left:5px solid rgb(219,2,23)">Prix choc</h5>
                                 </a>
