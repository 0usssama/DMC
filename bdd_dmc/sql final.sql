...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 21 avr. 2019 à 14:45
...
(11, 'ouadjaoud', 'sabrina', 'sabrina@gmail.com', 'sabrina@gmail.com', 'professionnel', '$2y$10$//Fb1Gr.sKEdsXMPtjSSJe5gpExOC39tJMCoMyouJqhbrQB6ruhse', '', 2);
...
ALTER TABLE `concerner`
  ADD CONSTRAINT `concerner_ibfk_1` FOREIGN KEY (`id_comd`) REFERENCES `commande` (`id_comd`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `concerner_ibfk_2` FOREIGN KEY (`id_prod`) REFERENCES `produit` (`id_prod`) ON DELETE CASCADE ON UPDATE CASCADE;
